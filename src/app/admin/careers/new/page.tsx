...
export default function NewJobPage() {
  ...
  const [location, setLocation] = useState("Lake Charles, LA");
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-steel-100">New Job Posting</h1>
            <p className="text-steel-400 mt-1">Create a new career opportunity</p>
          </div>
        </div>
      </div>
